  ...
  return (
    <section id="dashboard" className="py-20 bg-gray-50 dark:bg-gray-900/50">
      <div className="section-container">
        ...
        {/* Only display dashboards if there are visible ones */}
        ...
        {/* Only show featured dashboard section if admin or if there are dashboards */}
        {(isAuthenticated || visibleDashboards.length > 0) && (
