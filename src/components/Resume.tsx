...
const Resume: React.FC = () => {
  // Dummy data - will be replaced with real content later
  const experiences = [
    {
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <h5 className="font-medium">Microsoft Certified: Data Analyst Associate</h5>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Microsoft, 2021</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-portfolio-gold/10 flex items-center justify-center text-portfolio-gold flex-shrink-0">
                  ...
                  <div>
                    <h5 className="font-medium">Tableau Desktop Specialist</h5>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Tableau, 2020</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-portfolio-gold/10 flex items-center justify-center text-portfolio-gold flex-shrink-0">
                  ...
                  <div>
                    <h5 className="font-medium">Google Data Analytics Professional Certificate</h5>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Google, 2019</p>
                  </div>
                </li>
              </ul>
            </div>
